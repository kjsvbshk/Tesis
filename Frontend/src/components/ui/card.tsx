...
const Card = ({
  ...
  >
    ...
    <div className="absolute top-0 left-0 size-3 border-l-2 border-t-2 border-acid-500/30 -translate-x-[1px] -translate-y-[1px]" />
    <div className="absolute top-0 right-0 size-3 border-r-2 border-t-2 border-acid-500/30 translate-x-[1px] -translate-y-[1px]" />
    <div className="absolute bottom-0 left-0 size-3 border-l-2 border-b-2 border-acid-500/30 -translate-x-[1px] translate-y-[1px]" />
    <div className="absolute bottom-0 right-0 size-3 border-r-2 border-b-2 border-acid-500/30 translate-x-[1px] translate-y-[1px]" />
